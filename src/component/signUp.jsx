    ...
    <>
      <div className="LoginBody">
        <div id="boxLogin">
          ...
          <h1 className="TextHead">XPLUR
          <p className="smallText">Please signup To Your Account</p>
</h1>
<div className="Icons">
  
  <span className="icon">
  <svg xmlns="http://www.w3.org/2000/svg" width="81" height="70" viewBox="0 0 81 70"  fill=" #275efe">
  <rect width="80.0866" height="69.5489" rx="17.5189"  fill=" #275efe"/>
  ...
  <span className="icon">
  <svg xmlns="http://www.w3.org/2000/svg" width="81" height="70" viewBox="0 0 81 70"  fill=" #275efe">
  <rect x="0.108154" width="80.0866" height="69.5489" rx="17.5189"  fill=" #275efe"/>
...
<div className="stroke">
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="86" height="2" viewBox="0 0 86 2"  fill=" #275efe">
  <path d="M0 1H86"  stroke=" #275efe"/>
</svg></div>
<h2 > Or</h2>
  <div className="strokeLength"> <svg xmlns="http://www.w3.org/2000/svg" width="86" height="2" viewBox="0 0 86 2"  fill=" #275efe">
  <path d="M0 1H86"  stroke=" #275efe"/>
</svg></div>
</div>
        <div className="form" >
       ...
       <input type="text" id="email" name="email"  placeholder="Enter your email " onChange={handlechange} value={form.email}required/>
        ...
        <div className="link">
        Don’t Have Account?   <Link to="/signIn">  Login</Link>
</div>
        </div>
